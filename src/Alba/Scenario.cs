...
namespace Alba
{
    ...
    {
        public ScenarioResult(HttpContext context, IAlbaTestHost albaTestHost)
        {
            Context = context;
            ResponseBody = new HttpResponseBody(albaTestHost, context);
        }
    ...
    public class Scenario : IUrlExpression
    {
        ...
        internal Scenario(IAlbaTestHost system)
        {
            _system = system;
