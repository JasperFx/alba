...
namespace Alba
{
    ...
    {
        public static Dictionary<string, string> ParseQueryString(this IDictionary<string, object> env)
        {
            if (!env.ContainsKey(OwinConstants.RequestQueryStringKey)) return new Dictionary<string, string>();
