    ...
    public class HeaderValueAssertion : IScenarioAssertion
    {
        ...
        public void Assert(Scenario scenario, ScenarioAssertionException ex)
        {
            ...
            switch (values.Count())
            {
                case 0:
                    ex.Add(
                        $"Expected a single header value of '{_headerKey}'='{_expected}', but no values were found on the response");
                    break;
                ...
                case 1:
                    ...
                    {
                        ex.Add(
                            $"Expected a single header value of '{_headerKey}'='{_expected}', but the actual value was '{actual}'");
                    }
                    break;
